    ...
    <div className="openong-landing" id="top">
      ...
      <main>
        ...
        <section className="trust wrap">
          <p>Pensado para organizaciones de toda causa y tamaño</p>
        ...
        <footer className="footer">
          <div className="wrap foot-grid">
            <div className="col foot-brand">
              ...
              <p>
                La plataforma de IA que ayuda a tu ONG a recaudar fondos y
                financiar su misión.
              </p>
            </div>
            <div className="col">
              <h4>Producto</h4>
              <a href="#modulos">Campañas</a>
              <a href="#modulos">Tienda</a>
              <a href="#modulos">Núcleo de IA</a>
              <a href="#modulos">Panel de donaciones</a>
            </div>
            <div className="col">
              <h4>Recursos</h4>
              <a href="#como">Cómo funciona</a>
              <a href="#casos">Casos de uso</a>
              <a href="#">Guías para ONGs</a>
              <a href="#">Centro de ayuda</a>
            </div>
            <div className="col">
              <h4>Organización</h4>
              <a href="#">Sobre OpenONG</a>
          ...
          <div className="wrap foot-bottom">
            ...
            <span>Hecho para quienes hacen el bien</span>
          </div>
        </footer>
      </main>
